                      ...
                      <div class="d-flex">
                        ...
                        >
                          <div>
                            ...
                            <span class="text-sm">Ver todas las opciones</span>
                          </div>
                          <img
                            :src="downArrow"
                            alt="down-arrow"
                ...
                <ul class="list-group">
                  <li class="nav-item list-group-item border-0 p-0">
                    ...
                    >
                      ...
                      <span class="text-sm">Todo acerca de la clinica</span>
                    </a>
                  </li>
                  <li class="nav-item list-group-item border-0 p-0">
                    <a
                    ...
                    >
                      ...
                      <span class="text-sm"
                        >Profesionales con los que contamos</span
                      >
                    </a>
                  </li>
                  <li class="nav-item list-group-item border-0 p-0">
                    ...
                    >
                      ...
                      <span class="text-sm">Explore las especialidades</span>
                    </a>
                  </li>
                </ul>
              </div>
